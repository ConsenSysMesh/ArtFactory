...
/*
    Copyright 2017, Jordi Baylina; Modified 2018, Bill Gleim
...
/// @title ArtFactory Token Launch Contract
/// @author Bill Gleim
/// @dev This contract controls the issuance of tokens for the ArtFactory Token
...
/// @dev This is designed to control the issuance of a MiniMe Token for the
///  ArtFactory Campaign. This contract effectively dictates the terms of the
///  funding round.

contract ArtFactoryCampaign is TokenController, Owned {
...
/// @param _tokenAddress Address of the token contract this contract controls
    ...
    function Campaign(
        ...
        require ((_endFundingTime >= now) &&           // Cannot end in the past
            ...
            (_maximumFunding <= 1000000 ether) &&     // The Beta is limited
